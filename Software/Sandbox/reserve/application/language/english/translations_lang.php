...
// English
$lang['page_title'] = 'Reserve Time On';
$lang['step_one_title'] = 'Select Group & System';
$lang['select_service'] = 'Select Group';
$lang['select_provider'] = 'Select System';
$lang['duration'] = 'Duration';
$lang['minutes'] = 'Minutes';
$lang['price'] = 'Price';
$lang['back'] = 'Back';
$lang['step_two_title'] = 'Select Reservation Date And Time';
$lang['no_available_hours'] = 'There are no available reservation hours for the selected date. Please choose another date.';
$lang['appointment_hour_missing'] = 'Please select an reservation hour before continuing!';
...
$lang['step_four_title'] = 'Confirm Reservation';
$lang['confirm'] = 'Confirm';
$lang['update'] = 'Update';
$lang['cancel_appointment_hint'] = 'Press the "Cancel" button to remove the reservation from the schedule.';
$lang['cancel'] = 'Cancel';
$lang['appointment_registered'] = 'Your reservation has been successfully registered!';
$lang['cancel_appointment_title'] = 'Cancel Reservation';
$lang['appointment_cancelled'] = 'Your reservation has been successfully cancelled!';
$lang['appointment_cancelled_title'] = 'Reservation Cancelled';
$lang['reason'] = 'Reason';
$lang['appointment_removed_from_schedule'] = 'The following reservation was removed from the schedule.';
$lang['appointment_details_was_sent_to_you'] = 'An email with the reservation details has been sent to you.';
$lang['add_to_google_calendar'] = 'Add to Google Calendar';
$lang['appointment_booked'] = 'Your reservation has been successfully booked!';
$lang['thank_you_for_appointment'] = 'Thank you for arranging an reservation with us. Below you can see the reservation details. Make changes by clicking the reservation link.';
$lang['appointment_details_title'] = 'Reservation Details';
$lang['customer_details_title'] = 'User Details';
...
$lang['phone'] = 'Phone';
$lang['address'] = 'Address';
$lang['appointment_link_title'] = 'Reservation Link';
$lang['success'] = 'Success!';
$lang['appointment_added_to_google_calendar'] = 'Your reservation has been added to your Google Calendar account.';
$lang['view_appointment_in_google_calendar'] = 'Click here to view your reservation on Google Calendar.';
$lang['appointment_added_to_your_plan'] = 'A new reservation has been added to your plan.';
$lang['appointment_link_description'] = 'You can make changes by clicking the reservation link below.';
$lang['appointment_not_found'] = 'Reservation Not Found!';
$lang['appointment_does_not_exist_in_db'] = 'The reservation you requested does not exist in the system database anymore.';
...
$lang['reload'] = 'Reload';
$lang['appointment'] = 'Reservation';
$lang['unavailable'] = 'Unavailable';
$lang['week'] = 'Week';
$lang['month'] = 'Month';
$lang['today'] = 'Today';
$lang['not_working'] = 'Maintenance Period';
$lang['break'] = 'Break';
$lang['add'] = 'Add';
$lang['edit'] = 'Edit';
$lang['hello'] = 'Hello';
$lang['all_day'] = 'All Day';
$lang['manage_appointment_record_hint'] = 'Manage all the reservation records of the available providers and services.';
$lang['select_filter_item_hint'] = 'Select a provider or a service and view the reservations on the calendar.';
$lang['enable_appointment_sync_hint'] = 'Enable reservation synchronization with provider\'s Google Calendar account.';
$lang['manage_customers_hint'] = 'Manage the registered users and view their booking history.';
...
$lang['unavailable_periods_hint'] = 'During unavailable periods the provider won\'t accept new reservations.';
$lang['new_appointment_hint'] = 'Create a new reservation and store it into the database.';
$lang['reload_appointments_hint'] = 'Reload calendar reservations.';
$lang['trigger_google_sync_hint'] = 'Trigger the Google Calendar synchronization process.';
$lang['appointment_updated'] = 'Reservation updated successfully!';
$lang['undo'] = 'Undo';
$lang['appointment_details_changed'] = 'Reservation details have changed.';
$lang['appointment_changes_saved'] = 'Reservation changes have been successfully saved!';
$lang['save'] = 'Save';
$lang['new'] = 'New';
$lang['select'] = 'Select';
$lang['hide'] = 'Hide';
$lang['type_to_filter_customers'] = 'Type to filter users.';
$lang['clear_fields_add_existing_customer_hint'] = 'Clear the fields and enter a new users.';
$lang['pick_existing_customer_hint'] = 'Pick an existing user.';
$lang['new_appointment_title'] = 'New Reservation';
$lang['edit_appointment_title'] = 'Edit Reservation';
$lang['delete_appointment_title'] = 'Delete Reservation';
$lang['write_appointment_removal_reason'] = 'Please take a minute to write the reason you are deleting the reservation:';
$lang['appointment_saved'] = 'Reservation saved successfully!';
...
$lang['customer_saved'] = 'User saved successfully!';
$lang['customer_deleted'] = 'User deleted successfully!';
...
$lang['sunday'] = 'Sunday';
$lang['breaks'] = 'Breaks';
$lang['add_breaks_during_each_day'] = 'Add the working breaks during each day. During breaks the provider will not accept any reservations.';
$lang['day'] = 'Day';
$lang['days'] = 'Days';
...
$lang['about_app'] = 'About Easy!Reservations';
$lang['edit_working_plan_hint'] = 'Mark below the days and hours that your company will accept reservations. You will be able to adjust reservations in non working hours but the customers will not be able to book reservations by themselves in non working periods. This working plan will be the default for every new provider record but you will be able to change each provider\'s plan separately by editing his record. After that you can add break periods.';
...
$lang['book_advance_timeout_hint'] = 'Define the timeout (in minutes) before the customers can book or re-arrange reservations with the company.';
$lang['timeout_minutes'] = 'Timeout (Minutes)';
$lang['about_app_info'] = 'Easy!Reservations is a highly customizable web application that allows your customers to book reservations with you via the web. Moreover, it provides the ability to sync your data with Google Calendar so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using Easy!Reservations you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'Easy!Reservations is licensed under the GPLv3 license. By using the code of Easy!Reservations in any way you are agreeing to the terms described in the following url:';
...
$lang['book_appointment_title'] = 'Book Reservation';
...
$lang['delete_customer'] = 'Delete User';
...
$lang['delete_appointment'] = 'Delete Reservation';
...
$lang['no_privileges_edit_appointments'] = 'You do not have the required privileges to edit reservations.';
$lang['unavailable_updated'] = 'Unavailable time period updated successfully!';
$lang['appointments'] = 'Reservations';
...
$lang['next'] = 'Next';
$lang['now'] = 'Now';
$lang['select_time'] = 'Select Time (EDT GMT-4)';
$lang['time'] = 'Time';
$lang['hour'] = 'Hour';
$lang['minute'] = 'Minute';
...
$lang['select_google_calendar_prompt'] = 'Select the calendar that you want to sync your reservations. If you do not want to select a specific calendar the default one will be used.';
...
$lang['could_not_add_to_google_calendar'] = 'Your reservation could not be added to your Google Calendar account.';
$lang['ea_update_success'] = 'Easy!Reservations has been successfully updated!';
$lang['require_captcha'] = 'Require CAPTCHA';
$lang['require_captcha_hint'] = 'When enabled, the customers will have to type a random generated CAPTCHA string before booking/updating an reservation.';
$lang['captcha_is_wrong'] = 'CAPTCHA verification failed, please try again.';
$lang['any_provider'] = 'Any Provider';
$lang['requested_hour_is_unavailable'] = 'The requested reservation is unfortunately not available. Please select a different hour for your reservation.';
$lang['customer_notifications'] = 'User Notifications';
$lang['customer_notifications_hint'] = 'Defines whether the customer will receive email notifications whenever there is a schedule change on one of his reservations.';
