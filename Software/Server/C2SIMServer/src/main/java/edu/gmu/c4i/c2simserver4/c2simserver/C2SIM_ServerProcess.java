    ...
    */
    static void processManually(C2SIM_Transaction trans) throws C2SIMException {
        ...
        if (trans.protocol.equalsIgnoreCase(SISOSTD)) {
            ...
            // Check protocol version in message - If present use it if not get default from properties
            String c2simV = ch.getProtocolVersion();
            if(c2simV != null)if (c2simV == "")
                c2simV = C2SIM_Server.props.getProperty("defaultC2SIM_Version");
