...
either DIS or HLA1516e either. To start the interface DIS use runc2simVRF.bat or to run with 
HLA, use runc2simVRFHLA1516e.bat.

10. Treatment of reports described above assumes VRForces hostile forces will be under 
