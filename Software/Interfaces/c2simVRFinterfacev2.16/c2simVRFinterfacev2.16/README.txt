...
VERSION 16 uses C++ClientLibv4.8.0.3 with libboost-*-vc140-*
...
The top-level directory c2simVRFv2.16 can be installed in C:\
or elsewhere. This is changed from v2.6, which had to be located 
the vrforces4.6.1/examples directory. 

v2.15 includes binaries for C++C2SIMClientLibv4.8.0.3, which is 
...
c2simVRFv2.16 accepts a command line parameter (number 9) that
...
Effective with c2simVRFv2.15, it is possible to use the C2SIM 
