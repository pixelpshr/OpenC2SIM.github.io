...
// c2simVRFv2.17 updated to use C++ClientLibv4.8.0.3 1May2021
...
int main(int argc, char** argv)
{
	...
	std::cout << 
		"Starting VR-Forces C2SIM Interface v2.17 compatible VR-Forcesv4.9 using C2SIMv" << 
		c2simVersion << "\n"; 
