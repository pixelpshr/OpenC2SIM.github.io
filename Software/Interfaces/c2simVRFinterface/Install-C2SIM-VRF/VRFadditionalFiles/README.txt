INSTALLING C2SIMv1.0.1 INTERFACE AND ADDITIONS TO VRFORCESv4.9 using c2simVRF v2.17
...
1. Copy the c2simVRFv2.17 directory to wherever you want it to run, for example C:\. It 
...
9. Start the interface module after VRForces is up and running with a scenario, started for 
