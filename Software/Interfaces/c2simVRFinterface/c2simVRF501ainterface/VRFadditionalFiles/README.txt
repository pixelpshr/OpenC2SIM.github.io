INSTALLING C2SIMv1.0.2 INTERFACE AND ADDITIONS TO VRFORCESv5.0.1 using c2simVRF v2.27
...
1. Copy the c2simVRFinterfacev2.27 directory to wherever you want it to run, for example C:\. 
...
c2simVRFv2.27/C2SIMinterface.cpp.

5. The Tracking_Reports scripts cause VRForces to emit entity position information in textIf.cpp
which are used by the reportCallback function in c2simVRFinterfacev2.27/textIf.cpp to create 
