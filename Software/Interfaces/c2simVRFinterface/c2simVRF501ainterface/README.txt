...
VERSION 2.27 uses C++ClientLibv4.8.3.1 with libboost-*-vc140-*
...
https://vtmakcepstgagt01.blob.core.windows.net/productinstallers/vrForces/releasesAndPatches/5.0.1%2B/5.0.1a/vrForces5.0.1a-win64-vc15-20220810.exe

You must add to your Windows Path Environment Variable:
C:/MAK/vrforces5.0.1a/bin64 and C:/MAK/vrlink5.8/bin64

The top-level directory c2simVRFinterfacev2.27 can be installed in C:\
or elsewhere. 

v2.27 includes binaries for C++C2SIMClientLibv4.8.3.1, which is 
...
v2.27 is compatible with C2SIM v1.0.2. It accepts multiple
...
c2simVRFv2.27 accepts a ninth command line parameter that
...
c2simVRFv2.27 uses these command line parameters;
...
Version 2.27 includes support for batching multiple <ReportContent>
