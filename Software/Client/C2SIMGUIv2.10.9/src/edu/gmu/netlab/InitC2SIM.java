...
public class InitC2SIM {
    ...
    String pushInitC2SIM()
    {
        ...
        if(bml.debugMode)bml.printDebug("PUSH C2SIM INITIALIZE XML:"+pushInitInputString);
    ...
    String pushStatusC2SIM(){
        ...
        // invoke server command to fetch C3SIMInitialization
