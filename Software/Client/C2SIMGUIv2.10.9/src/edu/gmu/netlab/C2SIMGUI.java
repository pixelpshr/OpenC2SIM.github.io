...
public class C2SIMGUI extends JFrame implements WindowListener, HelpListener, 
    ...
    // Version
    public static String version = "2.10.9";
 ...
 */
    ...
    String c2simProtocolVersion = "1.0.0";
    ...
    String defaultC2simProtocolVersion = "1.0.0";
    ...
    static boolean ignoreXmlWithDupID;
    static boolean askAboutCheckingID;
    ...
    String bmlDocumentType = ""; // Order, Report, ..and what type of report
    ...
    static String C2SIMprotocolVersion;      // 0.0.9 or 1.0.0
    ...
    */
    ...
    public static void main(String[] args) {	
        ...
        c2simOrderSchemaLocation = 
            guiFolderLocation + "Schema/C2SIM/C2SIM_SMX_LOX_ASX_v1.0.0_Order_flat.xsd";
        c2simReportSchemaLocation = 
            guiFolderLocation + "Schema/C2SIM/C2SIM_SMX_LOX_ASX_v1.0.0_Report_flat.xsd";
        c2simInitSchemaLocation = 
            guiFolderLocation + "Schema/C2SIM/C2SIM_SMX_LOX_v1.0.0_Init_flat.xsd";
        asxReportSchemaLocation =
            guiFolderLocation + "Schema/C2SIM/C2SIM_SMX_LOX_ASX_v1.0.0_Report_flat.xsd.xsd";
   ...
   String getReportTime(String unitID)	
   {
    ...
    /**
     * makes a text String with 3 significANT digITS from float
     */
 ...
 (Widgets, Layout, and ActionListeners)
     ...
     */
    synchronized public void drawLocation(
        String[] stringArray, 
        ...
        if(moveFromLayer >= 0){
            ...
            // or move the Routelayer in routeLayers[]
        ...
        if (stringArray.length == 1){
            ...
            routeLayers[routeLayerIndex].setName(bmlDocumentType);
            routeLayers[routeLayerIndex].setVisible(true);
            mapHandler.add(routeLayers[routeLayerIndex]);
            routeLayerIndex++;
        }
            ...
            for (int i=0; i<stringArray.length; ++i){
                ...
                // C2SIM Report
                if(bmlDocumentType.equals("C2SIM Report")) {
                    isReport = true;
                    if(!parsedUnitID){
                ...
                // IBML09 Report
                else if(bmlDocumentType.equals("IBML09 Report")) {
                    isReport = true;
                ...
                // CBML Light Report
                else if(bmlDocumentType.equals("CBML Light Report")) {
                    isReport = true;
                ...
                // C2SIM Order
                else if(bmlDocumentType.equals("C2SIM Order")) {
                ...
                // IBML09 Order
                else if(bmlDocumentType.equals("IBML09 Order")) {
                ...
                // CBML Light Order
                else if(bmlDocumentType.equals("CBML Light Order")) {
            ...
            if(lookupRouteLayer == null || !isReport) {
                if(debugMode)printDebug("adding new map layer " + routeLayerIndex + 
                    " for " + testUnitID + " "+bmlDocumentType);
                String layerRelation = "";
                if(bmlDocumentType.endsWith("Order")){
                    checkRouteLayerFull();
                    routeLayers[routeLayerIndex] = 
                        new RouteLayer(stringArray, bmlDocumentType, xmlString, 
                    ...
                    if(lookupRouteLayer == null){// no report on this unit yet
                        ...
                        checkRouteLayerFull();
                        routeLayers[routeLayerIndex] = 
                            new RouteLayer(stringArray, bmlDocumentType, 
                ...
                routeLayers[routeLayerIndex].setName(
                    bmlDocumentType + layerRelation + sourceUnitName);
                routeLayers[routeLayerIndex].setVisible(true);
                mapHandler.add(routeLayers[routeLayerIndex]);
                routeLayerIndex++;
            }
    ...
    */
    ...
    synchronized void loadJaxFrontPanel() {
        ...
        if(first400.contains("CBMLReport"))
        {
            ...
            reportBMLType = "CBML";
            bmlDocumentType = "CBML Report From Server";	
            documentTypeLabel.setText(bmlDocumentType);
            xsdUrl = URLHelper.getUserURL(cbmlReportSchemaLocation);// CBML report chema XSD
            root = "CBMLReport";
        }
            ...
            reportBMLType = "C2SIM";
            bmlDocumentType = "C2SIM Report From Server";	
            documentTypeLabel.setText(bmlDocumentType);
            ...
            reportBMLType = "IBML";
            bmlDocumentType = "IBML09 Report From Server";
            documentTypeLabel.setText(bmlDocumentType);
            xsdUrl = 
    ...
    public void setServerStateLabel(String serverState) {
        ...
        if(serverState.equals("STOPPED")|| 
            serverState.substring(0,4).equals("Stop")) {
    ...
    private void saveTMP(boolean addLatLon, boolean arg1) {	
        ...
        if(debugMode)printDebug("refreshing a -------------------------- " + bmlDocumentType);
        if(bmlDocumentType == "OPORD"){
          
            // PULL DRAW OPORD INTO C2SIMGUI.java
    ...
    private void loadConfig() { 	
        ...
        try {   	
            ...
            c2simProtocolVersion = xpath.evaluate("//C2SIMprotocolVersion", w3cReportInfoDoc);
        ...
        String parm2)
   {
        ...
        boolean fromThisGui)// checking from this GUI or server
    {
        ...
        if(debugMode)printDebug("ItemIdNotUnique ignoreXmlWithDupID:" +
                ...
                // last instance until the next Item or end of array is found
                    ...
                    if(variantTagCompare(variant,currentXmlDataArray[xmlIndex],itemTag) 
                        ...
                        if(layerIdPosted != null){// null means not seen before
                            ...
                            if(askAboutCheckingID || fromThisGui){
    ...
    public boolean drawFromXML(
        ...
        //if(debugMode)printDebug("drawFromXML bmlDocumentType:"+bmlDocumentType);
        ...
        if(bmlDocumentType.equals("IBML09 Order")) {
            currentXmlDataArray = 
            ...
            }// end else/if(currentXmlDataArray == null)
        ...
        }// end else if{bmlDocumentType.equals("CBML Light Order")
        else if(bmlDocumentType.equals("C2SIM Order")){
            currentXmlDataArray = 
                xrp.getElementNameDataByTagName(
                    whereNodeTag,
        ...
        }// end else if{bmlDocumentType.equals("C2SIM Order")
        else if (reportBMLType.equals("IBML") &&
            bmlDocumentType.equals("IBML09 Report")){
                currentXmlDataArray = 
                    xrp.getElementNameDataByTagName(
                        whereNodeTag,
                        whereSingleTags,
            ...
            bmlDocumentType.equals("CBML Light Report")){
                currentXmlDataArray = 
                    xrp.getElementNameDataByTagName(
                        whereNodeTag,
                        whereSingleTags,
            ...
            bmlDocumentType.equals("C2SIM Report")){
                currentXmlDataArray = 
                    xrp.getElementNameDataByTagName(
                        whereNodeTag,
                        whereSingleTags,
            ...
            if(protocolVersion.equals(c2simProtocolVersion))
            if(itemIdNotUnique(
                currentXmlDataArray, 
            ...
            if(debugMode)printDebug(
                "bmlDocumentType is not an option we parse:" + bmlDocumentType);
            return false;
        }
        ...
        else if(bmlDocumentType.equals("C2SIM Report")) { 
          generalBMLFunction = "Report";
          generalBMLType = "C2SIM";
        }
        else if(bmlDocumentType.equals("CBML Light Report")) { 
