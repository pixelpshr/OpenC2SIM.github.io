...
public class Subscriber implements Runnable {
    ...
    public void interpretMessage(
        ...
        if(first500.contains(bml.c2simSystemCommandDomain)) {
           ...
           int stateStartIndex = messageBody.indexOf("<SystemMessageBody>") + 23;
           int stateEndIndex = messageBody.indexOf("</SystemMessageBody>>");
           if(stateEndIndex - stateStartIndex < 5){
                bml.printError("can't find state in message:" + messageBody);
                return;
            }
        ...
        if(first500.contains(bml.c2simInitializationDomain) ||
            ...
            if(bml.initializationDone) {
                ...
                // unless in Playback, don't process the initialize 
        ...
        //            !bml.runningServerTest){
        //            bml.printError(
        //                "invalid protocol code received:"+protocolVersion);
        //            return;
        //        }
                if(bml.runningServerTest)
                    if(protocolVersion.equals("0.0.9"))
 ...
 System.out.println("MESSAGEBODY5 PROTOCOL:" + protocolVersion + " SUBMITTER:" +
          submitter + " SELECTOR:" + messageSelector + " FIRST500:\n" + messageBody);                
 ...
 System.out.println("MESSAGEBODY6 PROTOCOL:" + protocolVersion + " SUBMITTER:" +
          submitter + " SELECTOR:" + messageSelector + " FIRST500:\n" + messageBody);
  ...
  System.out.println("MESSAGEBODY7 PROTOCOL:" + protocolVersion + " SUBMITTER:" +
          submitter + " SELECTOR:" + messageSelector + " FIRST500:\n" + messageBody);
