...
public class InitC2SIM {
    ...
    String pushC2simServerControl(String command)
    {
        ...
        if(bml.debugMode)
            bml.printDebug("C2SIM server control push result length: " +
    ...
    String pushCheckpointRestore(){return pushC2simServerControl("CPRESTORE");}
    String pushCheckpointSave(){return pushC2simServerControl("CPSAVE");}
    ...
    String pushLateJoinerC2SIM(){
        ...
        */
        ...
        //System.out.println("***LATEJOIN:"+messageBody);// for debug
